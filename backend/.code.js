...
// 8bit counter
const chunkOrRegister1 = new Register(!(lockCondition_1 || (chunkOrRegister1 === enableGate)), rst_n) // chunkOrRegister1
const chunkOp1 = (chunkOrRegister2 && chunkOrRegister1 && enableGate) // and3_2_14
const chunkOp2 = a211oi_2({A1: enableGate, C1: chunkOp1, B1: !((chunkOrRegister1 && enableGate) || chunkOrRegister2), A2: lockCondition_1}) // a211oi_2_0
const chunkOrRegister2 = new Register(chunkOp2, rst_n) // chunkOrRegister2
const chunkOrRegister3 = new Register((chunkOrRegister3 !== chunkOp1), rst_n) // chunkOrRegister3
const ChunkOp3 = a41oi_2({A4: enableGate, A1: chunkOrRegister2, A2: chunkOrRegister1, B1: chunkOrRegister4, A3: chunkOrRegister3}) // a41oi_2_0
const ChunkOp4 = a221oi_2({A1: enableGate, B2: chunkOrRegister4, B1: (chunkOrRegister2 && chunkOrRegister1 && chunkOrRegister3 && enableGate), C1: ChunkOp3, A2: lockCondition_1}) // a221oi_2_0
const chunkOrRegister4 = new Register(ChunkOp4, rst_n) // chunkOrRegister4
const lockCondition_1 = (!chunkOrRegister1 && !chunkOrRegister3 && chunkOrRegister4 && chunkOrRegister2) // lockCondition_1
const chunkOp5 = (lockCondition_1 && enableGate && otherChunkRegister1 && lockConditionRegister_2) // and4_2_2
const chunkOp6 = !(lockCondition_1 && enableGate) // nand2_2_23
const ChunkOp7 = o211a_2({C1: !chunkOp5, A2: chunkOp6, A1: lockCondition_3, B1: ((lockCondition_1 && enableGate && lockConditionRegister_2) || otherChunkRegister1)}) // o211a_2_7
const otherChunkRegister1 = new Register(ChunkOp7, rst_n) // dfrtp_2_15
const otherChunkRegister2 = new Register((otherChunkRegister2 !== chunkOp5), rst_n) // dfrtp_2_17
const chunkOp8 = o311a_2({A1: lockConditionRegister_2, C1: ((otherChunkRegister2 && chunkOp5) || otherChunkRegister3), A3: chunkOp6, A2: lockCondition_3, B1: !(otherChunkRegister2 && otherChunkRegister3 && chunkOp5)}) // o311a_2_1
const otherChunkRegister3 = new Register(chunkOp8, rst_n) // dfrtp_2_18
const lockCondition_3 = !(!otherChunkRegister2 && otherChunkRegister3 && otherChunkRegister1) // lockCondition_3
const lockConditionRegister_2 = new Register((lockConditionRegister_2 ? (lockCondition_1 && enableGate && lockCondition_3) : chunkOp6), rst_n) // lockConditionRegister_2\
// likely a comparison to 120
const lockRegister = new Register(((lockCondition_1 && !(lockConditionRegister_2 || lockCondition_3) && enableGate) || lockRegister), rst_n) // lockRegister
...
const or4_2_4 = (chunkOrRegister1 || chunkOrRegister2 || chunkOrRegister3 || chunkOrRegister4) // or4_2_4
const conb_1_2 = conb_1({}) // conb_1_2
const a221o_2_1 = a221o_2({A2: inputShift_09, B2: inputShift_10, C1: ((or4_2_4 && inputShift_00) || or4_2_4 || inputShift_11), B1: conb_1_2, A1: (chunkOrRegister1 || chunkOrRegister3 || !chunkOrRegister4 || !chunkOrRegister2)}) // a221o_2_1
...
const chunkOr1 = (chunkOrRegister2 || chunkOrRegister1 || chunkOrRegister3 || !chunkOrRegister4) // chunkOr1
const nor2_2_45 = !(chunkOr1 || locked) // nor2_2_45
const dfrtp_2_72 = new Register(((dfrtp_2_72 || nor2_2_45) && (dfrtp_2_69 || inv_2_20 || chunkOr1 || locked)), rst_n) // dfrtp_2_72
const dfrtp_2_69 = new Register(((dfrtp_2_72 && nor2_2_45) || dfrtp_2_69), rst_n) // dfrtp_2_69
const and4bb_2_12 = (!chunkOrRegister1 && !chunkOrRegister3 && chunkOrRegister4 && chunkOrRegister2) // and4bb_2_12
...
const and4bb_2_11 = (!chunkOrRegister2 && !chunkOrRegister3 && chunkOrRegister4 && chunkOrRegister1) // and4bb_2_11
...
const chunkOr2 = (chunkOrRegister2 || chunkOrRegister1 || chunkOrRegister4 || !chunkOrRegister3) // chunkOr2
const inv_2_19 = !dfrtp_2_65 // inv_2_19
const nor2_2_44 = !(chunkOr2 || lowIGated4) // nor2_2_44
const dfrtp_2_65 = new Register(((dfrtp_2_65 || nor2_2_44) && (dfrtp_2_79 || inv_2_19 || chunkOr2 || lowIGated4)), rst_n) // dfrtp_2_65
const dfrtp_2_79 = new Register(((dfrtp_2_65 && nor2_2_44) || dfrtp_2_79), rst_n) // dfrtp_2_79
const and4bb_2_9 = (!chunkOrRegister2 && !chunkOrRegister4 && chunkOrRegister3 && chunkOrRegister1) // and4bb_2_9
...
const and4bb_2_13 = (!chunkOrRegister1 && !chunkOrRegister4 && chunkOrRegister3 && chunkOrRegister2) // and4bb_2_13
...
const and4b_2_2 = (!chunkOrRegister4 && chunkOrRegister3 && chunkOrRegister1 && chunkOrRegister2) // and4b_2_2
...
const chunkOr3 = (chunkOrRegister2 || chunkOrRegister4 || chunkOrRegister3 || !chunkOrRegister1) // chunkOr3
const inv_2_17 = !dfrtp_2_76 // inv_2_17
const nor2_2_41 = !(chunkOr3 || lowIGated1) // nor2_2_41
const dfrtp_2_76 = new Register(((dfrtp_2_76 || nor2_2_41) && (dfrtp_2_61 || inv_2_17 || chunkOr3 || lowIGated1)), rst_n) // dfrtp_2_76
const dfrtp_2_61 = new Register(((dfrtp_2_76 && nor2_2_41) || dfrtp_2_61), rst_n) // dfrtp_2_61
const nor4_2_1 = !(chunkOrRegister2 || chunkOrRegister1 || chunkOrRegister4 || chunkOrRegister3) // nor4_2_1
...
const chunkOr4 = (chunkOrRegister1 || chunkOrRegister4 || chunkOrRegister3 || !chunkOrRegister2) // chunkOr4
const inv_2_18 = !dfrtp_2_62 // inv_2_18
const nor2_2_43 = !(chunkOr4 || lowIGated2) // nor2_2_43
const dfrtp_2_62 = new Register(((dfrtp_2_62 || nor2_2_43) && (dfrtp_2_77 || inv_2_18 || chunkOr4 || lowIGated2)), rst_n) // dfrtp_2_62
const dfrtp_2_77 = new Register(((dfrtp_2_62 && nor2_2_43) || dfrtp_2_77), rst_n) // dfrtp_2_77
const and4bb_2_10 = (!chunkOrRegister4 && !chunkOrRegister3 && chunkOrRegister1 && chunkOrRegister2) // and4bb_2_10
...
const and2_2_1 = (chunkOrRegister1 && lockConditionRegister_2) // and2_2_1
const nor2_2_7 = !(chunkOrRegister1 || lockConditionRegister_2) // nor2_2_7
const or2_2_1 = (and2_2_1 || nor2_2_7) // or2_2_1
const nand2_2_4 = !(chunkOrRegister1 && lockConditionRegister_2) // nand2_2_4
const xor2_2_0 = (lockConditionRegister_2 !== otherChunkRegister1) // xor2_2_0
const xnor2_2_1 = (chunkOrRegister2 === xor2_2_0) // xnor2_2_1
...
const xor2_2_7 = (lockConditionRegister_2 !== otherChunkRegister2) // xor2_2_7
const a21oi_2_10 = !((otherChunkRegister1 && xor2_2_7) || !(otherChunkRegister1 || otherChunkRegister2)) // a21oi_2_10
const xor2_2_1 = (chunkOrRegister3 !== a21oi_2_10) // xor2_2_1
const xnor2_2_0 = (!(chunkOrRegister2 && xor2_2_0) === xor2_2_1) // xnor2_2_0
const xnor2_2_2 = (xnor2_2_0 === nor2_2_0) // xnor2_2_2
const a32o_2_0 = ((chunkOrRegister2 && xor2_2_0 && xor2_2_1) || xnor2_2_0 || nor2_2_0) // a32o_2_0
const o2bb2a_2_0 = o2bb2a_2({A1_N: chunkOrRegister3, B2: otherChunkRegister2, A2_N: a21oi_2_10, B1: !(lockConditionRegister_2 && otherChunkRegister1)}) // o2bb2a_2_0
const xor2_2_4 = (otherChunkRegister3 !== xor2_2_7) // xor2_2_4
const nand2_2_17 = !(otherChunkRegister1 && otherChunkRegister2) // nand2_2_17
const xnor2_2_4 = (nand2_2_17 === xor2_2_4) // xnor2_2_4
const xnor2_2_5 = (chunkOrRegister4 === xnor2_2_4) // xnor2_2_5
...
const nand2_2_21 = !(lockConditionRegister_2 && otherChunkRegister2) // nand2_2_21
const nand2_2_22 = !(otherChunkRegister3 && xor2_2_7) // nand2_2_22
const xnor2_2_3 = (otherChunkRegister1 === otherChunkRegister3) // xnor2_2_3
const nor2_2_17 = !(nand2_2_21 || xnor2_2_3) // nor2_2_17
const or3_2_5 = (!(otherChunkRegister1 || nand2_2_22) || nor2_2_17 || (nand2_2_21 && nand2_2_22 && xnor2_2_3)) // or3_2_5
const nand2_2_16 = !(chunkOrRegister4 && xnor2_2_4) // nand2_2_16
...
const o22ai_2_0 = o22ai_2({A1: otherChunkRegister1, B1: !((otherChunkRegister1 && otherChunkRegister3) || otherChunkRegister2), A2: nand2_2_22, B2: ((otherChunkRegister1 && otherChunkRegister2 && otherChunkRegister3) || nor2_2_17)}) // o22ai_2_0
const and4bb_2_0 = (!lockConditionRegister_2 && !otherChunkRegister1 && otherChunkRegister2 && otherChunkRegister3) // and4bb_2_0
...
const a21o_2_4 = ((nand2_2_17 && nor2_2_17) || !((otherChunkRegister3 && nand2_2_17) || nor2_2_17)) // a21o_2_4
const xnor2_2_7 = (a21oi_2_7 === a21o_2_4) // xnor2_2_7
const o211a_2_0 = o211a_2({A2: otherChunkRegister1, A1: lockConditionRegister_2, B1: otherChunkRegister2, C1: otherChunkRegister3}) // o211a_2_0
...
const weirdLockRegister1 = new Register(!((weirdLockRegister1_N && nand2_2_25) || (enableGate_N ? lockCondition_1 : weirdLockRegister1_N)), rst_n) // weirdLockRegister1
const o211a_2_8 = o211a_2({A2: nand2_2_25, B1: or2_2_7, C1: enableGate, A1: weirdLockRegister1}) // o211a_2_8
const weirdLockRegister2 = new Register(((enableGate_N && weirdLockRegister2) || o211a_2_8 || !lockCondition_1), rst_n) // weirdLockRegister2
const nand2_2_25 = !(weirdLockRegister2 && I) // nand2_2_25
const failRegister2 = new Register(((lockCondition_1 && enableGate && (weirdLockRegister1 ? nand2_2_25 : or2_2_7)) || failRegister2), rst_n) // failRegister2
